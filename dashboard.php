...
if(isset($_POST['submit'])){
  ...
  $account_radio=$_POST['account_radio'];
  $optional=$_POST['optional'];

  $row=mysqli_query($link,"INSERT INTO `add_new_product`(`product_type`, `product_brand`, `product_vendor`, `product_name`, `product_price`, `product_stock`,`account_radio`,`optional`) VALUES ('$product_type', '$product_brand', '$product_vendor', '$product_name','$product_price', '$product_stock','$account_radio','$optional')" );
 ...
 if(isset($_POST['add_sale'])){
      ...
      $record_new_sale  = $_POST['record_new_sale'];
      $product_price    = $_POST['product_price'];
      $optional         = $_POST['optional'];

      $row2   = mysqli_query($link, "INSERT INTO `add_sale`(`record_new_sale`, `product_price`, `optional`) VALUES ('$record_new_sale', '$product_price', '$optional')");

      if(isset($row2)){
  
      echo'<script>alert("add sale successfully")</script>';
          ...
          <form class="" method="POST">
            <div class="modal-body">
              <div class="form-group">
                ...
                <select class="form-control text-primary" name="record_new_sale" required>
                  <option disabled selected value="Please select a product"><sub>Please select a product</sub></option>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="product_price" value="" placeholder="Enter product price here..." required>
              </div>
              <div class="form-group">
                <label for="">Description <small class="text-muted">(Optional)</small></label>
                <textarea name="optional" class="form-control" rows="8" cols="80" placeholder="Add some note or description about this sale..."></textarea>
              </div>
              <small class="text-muted"><em>Please double check information before submitting.</em></small>
            </div>
            <div class="modal-footer">
              <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
              <input type="submit" class="btn btn-primary" name="add_sale" >
            </div>
          </form>
        </div>
      </div>
            ...
            <div class="modal-body">
              <div class="form-group" >
                ...
                <select class="form-control text-primary" name="product_type" required>
                  ...
                  <option value="Headphones & MICs">Headphones & MICs</option>
                  <option value="Mousepads">Mousepads</option>
                  <option value="Mice & Pointing Devices">Mice &amp; Pointing Devices</option>
              ...
              <div class="form-group">
                ...
                <select class="form-control text-primary" required name="product_brand">
              ...
              <div class="form-group">
                ...
                <select class="form-control text-primary" name="product_vendor" required>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" name="product_price" value="" placeholder="Enter cost of product per item..." required>
              </div>
              <div class="form-group">
              ...
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="account_radio" id="exampleRadios1" value="option1" checked>
                  Store Account
                </label>
              </div>
              <div class="form-check">
                <label class="form-check-label">
                  <input class="form-check-input" type="radio" name="account_radio" id="exampleRadios2" value="option2">
              ...
              <div class="form-group">
                <label for="">Description <small class="text-muted" >(Optional)</small></label>
                <textarea name="optional" class="form-control" cols="80" placeholder="Add some note or description about this product..."></textarea>
              </div>
              <small class="text-muted"><em>Please double check information before submitting.</em></small>
            </div>
            <div class="modal-footer">
